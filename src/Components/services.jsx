...
function Navbar() {
  return (
    <div sx={{}}> 
      <Box sx={{marginLeft:"100px",width:"20%", display:"flex", justifyContent:"space-around" , selfAlign:"right"}}>
      <PersonOutlineOutlinedIcon sx={{color:"black", width:"40px",height:"40px",margin:"0px 12px"}}/>
      <MessageOutlinedIcon sx={{color:"black", width:"40px",height:"40px",margin:"0px 12px"}}/>
      <ShoppingCartOutlinedIcon sx={{color:"black", width:"40px",height:"40px",margin:"0px 12px"}}/>
